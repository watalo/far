...
# 重构FinancialStatement类
class FinancialStatement():
    def __init__(self, name, xlsxpath):
        self.name = name
    ...
    def read_xlsx(self):
        ...
        ws = load_workbook(self.xlsxpath,
                           data_only=True)
        ws.save(os.path.abspath(self.xlsxpath))
        fs_df = pd.read_excel(io=self.xlsxpath,
                              sheet_name='Sheet1',
